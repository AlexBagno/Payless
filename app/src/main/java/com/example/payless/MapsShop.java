...
public class MapsShop extends FragmentActivity implements OnMapReadyCallback {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null){
                    ...
                    supportMapFragment.getMapAsync(MapsShop.this);
                }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng gasL = new LatLng(48.51, 35.05);
        MarkerOptions gas = new MarkerOptions().position(gasL).title("ОККО").flat(true).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
